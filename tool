...
# PRE_DEFINE_CATEGORIES = {"nodule": 0}                       
...
def get_filename_as_int(filename):
    try:
        ...
        filename = filename.lstrip('unknow')
...
if __name__ == '__main__':
    root_path = os.getcwd()
    xml_train_dir = os.path.join('xml-train')
    xml_val_dir = os.path.join('xml-val')
    ...
    json_file_train = 'coco2017-base/annotations/instances_train2017.json'
    json_file_test = 'coco2017-base/annotations/instances_val2017.json'
    # your original image dir
    all_img_dir = 'chromosome_original/'
    # put original image to coco/train or val
    coco_img_train = 'coco2017-base/train2017/'
    coco_img_test = 'coco2017-base/val2017/'
